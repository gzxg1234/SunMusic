 ...
 */
public abstract class BaseDataFrag<T> extends BaseFragment implements DataListAdapter.OnItemClickListener, DataListAdapter.OnItemActionClickListener, DataListAdapter.OnItemLongLickListener, Observer {
    ...
    public BaseDataFrag(int layout, String[] subscribes) {
        this.layout = layout;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new DataListAdapter<T>(getContext(), layoutid) {
            ...
            public void onBindViewHolder(ItemHolder holder, int position) {
                ...
                BaseDataFrag.this.bindViewHolder(holder, position);
    ...
    public boolean onItemLongClick(View view, final int position) {
        ...
        getActivity().startActionMode(new ActionMode.Callback() {
            public static final int menu_selected_all = 1;
            @Override
            public boolean onCreateActionMode(final ActionMode mode, Menu menu) {
                menu.add(Menu.NONE,menu_selected_all,Menu.NONE,"全选")
                        .setIcon(R.mipmap.ic_select_all_black_24dp)
