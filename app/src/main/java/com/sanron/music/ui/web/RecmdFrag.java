 ...
 */
public class RecmdFrag extends LazyLoadFragment implements View.OnClickListener {
    ...
    public final int RECMD_SONG_NUM = 5;
    ...
    protected void loadData() {
        ...
        //获取推荐歌曲
        MusicApi.recmdSongs(RECMD_SONG_NUM, new JsonCallback<RecmdSongData>() {
        ...
        private void createViews() {
            ...
            if (data != null) {
                for (int i = 0; i < data.size(); i++) {
                    ...
                    ImageLoader.getInstance().displayImage(focusPic.picUrl, view, mDisplayImageOptions);
                }
            }
        }
