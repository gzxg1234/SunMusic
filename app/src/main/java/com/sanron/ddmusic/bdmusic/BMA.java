package com.sanron.ddmusic.bdmusic;
...
//		}
    ...
    public static class Tag {
         ...
         * @return
         */
        public static String hotTag(int num) {
            StringBuffer sb = new StringBuffer(BASE);
    ...
    public static class Song {
         ...
         * @return
         */
        public static String baseInfo(String songid) {
            StringBuffer sb = new StringBuffer(BASE);
    ...
    public static class Artist {
         ...
         * @return
         */
        public static String artistSongList(String artistid, int offset, int limit) {
            StringBuffer sb = new StringBuffer(BASE);
         ...
         * @return
         */
        public static String artistInfo(String artistid) {
            StringBuffer sb = new StringBuffer(BASE);
